...
namespace V2boardApi.Controllers
{
    ...
    public class UserController : ApiController
    {
            ...
            try
            {
                ...
                if (Token != null)
                {
                    ...
                    if (User != null)
                    {
                        ...
                        {
                            MySqlEntities.Connect(User.tbServers.ConnectionString);
                            string Query = "select * from v2_user where";
                            if (name != null)
                            {
        ...
        //                            exp.Add("email_prefix", createUser.name.Replace(' ', '_').ToLower());
        ...
        //                    Dictionary<string, string> exp = new Dictionary<string, string>();
        //                    int ban = 0;
        //                    if(!model.IsBanned && model.Plan_ID == 0)
        //                    {
        //                        ban = 1;
        //                    }
